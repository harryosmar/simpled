var datatable =  function(_site){
    var datatable_id = "#datatable-cms";
    var datepicker_class = ".datatable-datepicker";
    var oTable = null;
    var dom = datatable_setting['dom'];
...
//        });
    ...
    function set_single_column_input_filter_event(){
    ...
    function do_reset_single_column(){
        for (var $index in datatable_setting['columnDefs']) {
            if (typeof (datatable_setting['columnDefs'][$index]) !== "undefined" && datatable_setting['columnDefs'][$index]["visible"] === true && datatable_setting['columnDefs'][$index]['searchable'] == true) { //if column from database
                $column_title = datatable_setting['columnDefs'][$index]['db'];
    ...
    function do_search_single_column(){
...
//            });
    ...
    function init_datatable_datepicker(){
           //Set Datepicker
    ...
    function init_datatable(){
        datatable.oTable = $(datatable.datatable_id).DataTable({
            ...
            "ajax": $.fn.dataTable.pipeline({
                url: class_url + "datatable_server_processing"+query_string,
    ...
    parent['datatatable_init'] = datatatable_init;
    parent['set_single_column_input_filter_event'] = set_single_column_input_filter_event;
    parent['do_reset_single_column'] = do_reset_single_column;
    parent['do_search_single_column'] = do_search_single_column;
    parent['refresh_datatable'] = refresh_datatable;
    parent['init_datatable'] = init_datatable;
    parent['init_datatable_datepicker'] = init_datatable_datepicker;
    return parent;
}(site || {});
