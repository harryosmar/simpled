<div class="btn-group">
    ...
    <ul class="dropdown-menu" role="menu">
        <?php if (preg_match("/(view,|view$)/i", $privilege_action)): ?>
            <li><a href="<?php echo "{$class_url}view/{$row->$primary_key}"; ?>">View</a></li>
        <?php endif; ?>
        <?php if (preg_match("/(edit,|edit$)/i", $privilege_action) && $row->posted == 'NO'): ?>
            <li><a href="<?php echo "{$class_url}edit/{$row->$primary_key}"; ?>">Edit</a></li>
        <?php endif; ?>
        <?php if (preg_match("/(delete,|delete$)/i", $privilege_action) && $row->posted == 'NO'): ?>
