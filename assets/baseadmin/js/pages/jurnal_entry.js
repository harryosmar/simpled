var jurnal_entry = {
    ...
    generate_row : function(removable){
        ...
        return ''.concat('<div class="row-transaction-detail clearfix">',
                    ...
                    '</div>',
                    '{2}',
                '</div>').format(json_data['dropdown_coa'], json_data['disabled_amount'], removable == true ? '<a class="btn btn-danger pull-right" href="javascript:;" role="button" data-name="remove-row"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>' : '');
    },
