			        ...
			        <div class="tab-pane" id="tab_1">
			            <form action="#" name="reset-password-form" id="reset-password-form" class="form-horizontal" role="form">
			                ...
			                <div class="form-group" for="admin_password">
			                    <label for="admin_password" class="col-sm-2 control-label">Your Old Password</label>
			                    <div class="col-sm-10 controls">
			                        <input type="password" name="admin_password" value="" id="admin_password" class="form-control" placeholder="Old Password">            
			                    </div>
			                </div>
